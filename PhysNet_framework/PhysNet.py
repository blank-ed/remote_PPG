...
from PhysNet.PhysNetED_BMVC import PhysNet_padding_Encoder_Decoder_MAX
...
cap = cv2.VideoCapture(r'C:\Users\Admin\Desktop\Riccardo New Dataset\test_L00_no_ex_riccardo_all_distances\D02.mp4')  # Start 15:44:11 End 15:42:12
...
video_data = frames[0:128]
bvp_data = np.array(bvp_data[0:128])
